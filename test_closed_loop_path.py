...
with app.app_context():
    ...
    def test_closed_loop_path():
        ...
        # 测试数据：起点城市和目标城市相同（闭环路径）
        start_city = "大连"
        target_city = "大连"  # 目标城市与起点城市相同
        days = 2
        
        # 测试路径生成
        print(f"测试从{start_city}到{target_city}的闭环路径生成...")
